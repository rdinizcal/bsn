...
compile-main:
	g++ -std=c++11 -c odv/tcp_triggers/apps/tcp_listener.cpp -o odv/tcp_triggers/build/tcp_listener.o
	g++ -o odv/tcp_triggers/build/tcp_listener odv/tcp_triggers/build/tcp_listener.o libbsn/build/SensorData.o odv/communication/build/TCPReceiveBytes.o -lopendavinci -lpthread
	g++ -std=c++11 -c odv/communication/apps/main.cpp -o odv/communication/build/main.o
	g++ -o odv/communication/build/main odv/communication/build/main.o odv/communication/build/TCPSendBytes.o odv/communication/build/TCPReceiveBytes.o -lopendavinci -lpthread
...
test_comunications:
	...
	@g++ -o odv/communication/test/main.out odv/communication/test/a.o odv/communication/build/TCPSendBytes.o odv/communication/build/TCPReceiveBytes.o -lopendavinci -lpthread
...
test_BodyHubEntity:
	...
	@g++ -o libbsn/test/main.out libbsn/test/a.o libbsn/build/BodyHubEntity.o libbsn/build/PersistenceModule.o libbsn/build/SensorData.o libbsn/build/VitalStatistics.o -lopendavinci -lpthread
