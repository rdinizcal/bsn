...
run_tests: test_comunications test_vitalstatistics test_BodyHubEntity
compile-odv:
...
compile-main:
	...
	g++ -o odv/communication/build/main odv/communication/build/main.o odv/communication/build/TCPReceiveBytes.o odv/communication/build/TCPSendBytes.o odv/communication/build/consumer.o -lopendavinci -lpthread
...
test_BodyHubEntity:
	...
	@g++ -std=c++11 -c libbsn/test/runner.cpp -o libbsn/test/a.o 
	@g++ -o libbsn/test/main.out libbsn/test/a.o libbsn/build/BodyHubEntity.o libbsn/build/SensorData.o libbsn/build/PersistenceModule.o libbsn/build/VitalStatistics.o -lopendavinci -lpthread
	./libbsn/test/main.out
install:
