...
compile-main:
	...
	g++ -o odv/tcp_triggers/listener/build/tcp_listenerApp odv/tcp_triggers/listener/build/tcp_listenerApp.o libbsn/build/SensorData.o odv/tcp_triggers/listener/build/tcp_listener.o libbsn/build/TCPReceive.o -lopendavinci -lpthread
...
test_BodyHubEntity:
	...
	@g++ -o libbsn/test/main.out libbsn/test/a.o libbsn/build/PersistenceModule.o libbsn/build/SensorData.o libbsn/build/VitalStatistics.o libbsn/build/BodyHubEntity.o -lopendavinci -lpthread
	./libbsn/test/main.out
test_comunications:
	@cxxtestgen --error-printer -o libbsn/test/runner.cpp libbsn/test/test_comunications.h
	@g++ -std=c++11 -c libbsn/test/runner.cpp -o libbsn/test/a.o 
	@g++ -o libbsn/test/main.out libbsn/test/a.o libbsn/build/TCPSend.o libbsn/build/TCPReceive.o -lopendavinci -lpthread
	./libbsn/test/main.out
